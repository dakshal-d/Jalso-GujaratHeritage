        ...
        <section className='mt-20 sm:text-center'>
            ...
            <div className="mx-40 my-20 px-20 py-12 text-xl flex items-center bg-white border border-gray-200 rounded-lg shadow  hover:bg-gray-100 dark:border-gray-700 ">
                <div className="flex flex-col justify-between p-4 leading-normal">
                    <h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Gujarat is a state in western India known for its rich history, diverse culture, and vibrant tourism industry. Here are some data points on Gujarat tourism:</h5>
