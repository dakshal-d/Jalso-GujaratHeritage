...
function Hero() {
    return (
        <section className="bg-white dark:bg-gray-900 mt-20 ">
                        ...
                        {/* style={{ backgroundImage: "url('/images/SOU.jpg')" }} */}
                            <p className='text-orange-600 font-bold p-3'>
                            ...
                            <div className='flex justify-center items-center'>
                                <p className='md:text-5xl sm:text-4xl text-xl font-bold py-4 dark:text-white'>
                                    <span className='text-orange-600'>RELIVE</span> every moment of 
                                </p> 
            ...
            <div className="grid max-w-screen-xl px-4 mx-40 lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12 ">
                <div className=" p-4 bg-gray-100 rounded-xl mr-16 lg:col-span-7 dark:bg-gray-900">
    ...
    Get the Best Travel and Food in <span className='text-orange-600'>Gujarat</span>
</h1>
