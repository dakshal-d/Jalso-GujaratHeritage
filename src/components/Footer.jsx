...
<footer className="bg-gray-100 dark:bg-gray-900">
    <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
          ...
          <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
              <div>
                  ...
                  <ul className="text-gray-600 dark:text-gray-400 font-medium">
                      <li className="mb-4">
                          <a href="" className="hover:underline">Gujarat cuisine</a>
                      </li>
                      <li>
                          <a href="" className="hover:underline">Gujarat Tourism</a>
                      </li>
                  </ul>
              </div>
              <div>
      ...
      <div className="sm:flex sm:items-center sm:justify-between">
          <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a href="" class="hover:underline">Jalso™</a>. All Rights Reserved.
          </span>
